...
class RelatedUsersControllerTest {
  ...
  @InjectMocks private RelatedUsersController relatedUsersController;

  @Mock private JobExecutionEntityCqlRepository jobExecutionEntityCqlRepository;

  @Test
  @TestMate(name = "TestMate-268e302a3b7b338bca67c2d79808e581")
  void getRelatedUsersShouldReturnUniqueUsersWhenMultipleJobsRunBySameUser() {
    // Given
    var userA = new JobExecutionRunBy().userId("user-a-id").firstName("User").lastName("A");
    var userB = new JobExecutionRunBy().userId("user-b-id").firstName("User").lastName("B");
    ...
    var jobExecutionEntities =
        List.of(jobExecutionEntity1, jobExecutionEntity2, jobExecutionEntity3);
    ...
    assertThat(relatedUserCollection.getRelatedUsers())
        .hasSize(2)
  ...
  @Test
  @TestMate(name = "TestMate-bb37d451fdfa8ad27832a6df3f669363")
  ...
  @Test
  @TestMate(name = "TestMate-d613f91b15dac21be007b0a6671f4c46")
  void getRelatedUsersShouldFilterOutJobsWithNullRunBy() {
    ...
    var jobExecutionEntityWithUser =
        JobExecutionEntity.builder().jobExecution(jobExecutionWithUser).build();
    var jobExecutionEntityWithoutUser =
        JobExecutionEntity.builder().jobExecution(jobExecutionWithoutUser).build();
  ...
  @Test
  @TestMate(name = "TestMate-476c95d1b98f1886a713ffd5342caad0")
  void getRelatedUsersShouldCorrectlyMapAllUserFields() {
    // Given
    var runBy =
        new JobExecutionRunBy().userId("test-user-id-123").firstName("John").lastName("Doe");
    ...
    var expectedRelatedUser =
        new RelatedUser().userId("test-user-id-123").firstName("John").lastName("Doe");
