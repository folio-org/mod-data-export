...
class S3FilePathUtilsTest {
  ...
  void getTempDirForJobExecutionIdTest() {
    ...
    assertEquals(
        "tmp/mod-data-export/download/7aadccbf-63a1-4c66-bb3a-83365649236c/",
        S3FilePathUtils.getTempDirForJobExecutionId("tmp", uuid));
    assertEquals(
        "mod-data-export/download/7aadccbf-63a1-4c66-bb3a-83365649236c/",
  ...
  void getLocalStorageWriterPath() {
    assertEquals(
        "tmp/fileLocation", S3FilePathUtils.getLocalStorageWriterPath("tmp", "fileLocation"));
