...
class FolioHoldingsAllRepositoryIT extends AllRepositoryBaseIT {
  ...
  @Autowired private FolioHoldingsAllRepository folioHoldingsAllRepository;
  ...
  void findFolioHoldingsAllDeletedNonSuppressedCustomHoldingsProfileTest() {
    try (var context = new FolioExecutionContextSetter(folioExecutionContext)) {
      var list =
          folioHoldingsAllRepository.findMarcHoldingsAllDeletedNonSuppressedCustomHoldingsProfile();
      assertThat(list).hasSize(2);
    }
  }
}
