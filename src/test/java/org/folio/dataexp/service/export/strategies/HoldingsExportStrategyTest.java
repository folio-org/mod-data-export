...
//            new ExportStrategyStatistic(new ExportedMarcListener(null, 1000, null)));
//
//    var actualErrorMessage = List.of("marc error for holding
// 0eaa7eef-9633-4c7e-af09-796315ebc576");
//    verify(ruleFactory).getRules(isA(MappingProfile.class));
//    verify(ruleHandler).preHandle(isA(JSONObject.class), anyList());
...
//    var holdingsWithInstanceAndItems =
//        holdingsExportStrategy.getHoldingsWithInstanceAndItems(
//            new HashSet<>(Set.of(holdingId)), generatedMarcResult, mappingProfile,
// jobExecutionId);
//
