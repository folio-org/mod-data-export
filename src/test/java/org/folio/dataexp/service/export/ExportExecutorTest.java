...
class ExportExecutorTest {
  ...
  void exportTest() {
    ...
    when(instancesExportStrategy.saveOutputToLocalStorage(isA(JobExecutionExportFilesEntity.class), isA(ExportRequest.class), isA(ExportedMarcListener.class))).thenReturn(new ExportStrategyStatistic(new ExportedMarcListener(null, 1000, null)));
