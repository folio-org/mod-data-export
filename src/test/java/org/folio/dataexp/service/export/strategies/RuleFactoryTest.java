...
void getRulesShouldReturnAllRulesWhenNoSuppressionIsActive() throws TransformationRuleException {
  // TestMate-7e6135e04aa1ae0d5457e4de2d286332
  // Given
  ...
  assertThat(actualRules)
      .hasSize(3)
      .containsExactly(rule001, rule999ff, rule100);
}

    @Test
@TestMate(name = "TestMate-getRulesShouldFilter999ffWhenSuppress999ffIsTrue")
void getRulesShouldFilter999ffWhenSuppress999ffIsTrue() throws TransformationRuleException {
  // TestMate-b94b4a5ac8d1a9ce863cfd71b32fae81
  // Given
  var mappingProfile = new MappingProfile();
  ...
  assertThat(actualRules)
    ...
    @Test
@TestMate(name = "TestMate-getRulesShouldFilterSpecificFieldsWhenFieldsSuppressionIsProvided")
void getRulesShouldFilterSpecificFieldsWhenFieldsSuppressionIsProvided() throws TransformationRuleException {
  // TestMate-f7765c57a9febf00d15cf800bde8e339
  // Given
  var mappingProfile = new MappingProfile();
  mappingProfile.setSuppress999ff(false);
  ...
  // Create a spy of the injected ruleFactory to allow partial mocking of the internal buildRules method
  var spyRuleFactory = org.mockito.Mockito.spy(ruleFactory);
  doReturn(initialRules).when(spyRuleFactory).buildRules(any(MappingProfile.class));
  // When
  var actualRules = spyRuleFactory.getRules(mappingProfile);
  ...
  assertThat(actualRules)
      .hasSize(1)
      .containsExactly(rule100)
      .doesNotContain(rule500, rule700);
}

    @Test
  @TestMate(name = "TestMate-getRulesShouldApplyBoth999ffAndFieldsSuppressionSimultaneously")
  void getRulesShouldApplyBoth999ffAndFieldsSuppressionSimultaneously() throws Exception {
    // TestMate-93134a9d3263b79be86f19751c59449b
    // Given
    var mappingProfile = new MappingProfile();
    mappingProfile.setSuppress999ff(true);
    ...
    assertThat(actualRules)
        .hasSize(1)
        .containsExactly(rule200)
        .doesNotContain(rule999ff, rule100);
  }

    @Test
void getRulesShouldHandleEmptyFieldsSuppressionStringGracefully() throws TransformationRuleException {
  // TestMate-26fcc3a6bd98ea236e266e45d0107973
  // Given
  var mappingProfile = new MappingProfile();
  mappingProfile.setSuppress999ff(false);
  ...
  assertThat(actualRules)
      .hasSize(2)
      .containsExactly(rule100, rule245);
}
}
