...
class FieldIdBuilderUnitTest {
  ...
  void shouldReturnCorrectFieldId_whenBuildWithReferenceData() {
    String fieldIdValue = fieldIdBuilder.build(RecordTypes.INSTANCE, FIELD_CONFIG_IDENTIFIER_ID, REFERENCE_DATA_CONTROL_NUMBER_NAME);
  ...
  void shouldReturnCorrectFieldId_whenBuildWithEmptyReferenceData() {
    String fieldIdValue = fieldIdBuilder.build(RecordTypes.INSTANCE, FIELD_CONFIG_IDENTIFIER_ID, StringUtils.EMPTY);
