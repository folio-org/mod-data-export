...
class JobExecutionServiceTest {
  ...
  @InjectMocks private JobExecutionService jobExecutionService;

  @Mock private JobProfileService jobProfileService;

  @Test
  @TestMate(name = "TestMate-3db225a034406710ed2ebf6ca229f351")
  void setCompletedDateForFailedExecutionsIfRequiredShouldSetLastUpdatedDateWhenAvailable() {
    ...
    var jobExecutionEntity =
        JobExecutionEntity.builder().id(jobExecutionId).jobExecution(jobExecution).build();
    when(jobExecutionEntityCqlRepository.getFailedExecutionsWithoutCompletedDate())
        .thenReturn(List.of(jobExecutionEntity));
    when(jobExecutionEntityCqlRepository.save(
            org.mockito.ArgumentMatchers.any(JobExecutionEntity.class)))
  ...
  @Test
  @TestMate(name = "TestMate-cdc5edee454f195c44d3184518f38806")
  void
      setCompletedDateForFailedExecutionsIfRequiredShouldSetCurrentDateWhenLastUpdatedDateIsNull() {
    // Given
    ...
    try (MockedConstruction<Date> mockedDate =
      ...
      var capturedEntity = captor.getValue();
      var capturedJobExecution = capturedEntity.getJobExecution();
      assertThat(capturedJobExecution.getCompletedDate().getTime())
  ...
  @Test
  @TestMate(name = "TestMate-eade8086f13d298ac8279b8d6039a12b")
