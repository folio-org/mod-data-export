...
public class ExportManagerTest extends RestVerticleTestBase {
  ...
  public ExportManagerTest() {
    ...
    SpringContextUtil.init(vertxContext.owner(), vertxContext, TestConfig.class);
  ...
  private FileDefinition givenUploadFile(String fileName) throws IOException {
    File fileToUpload = getFileFromResourceByName(FILES_DIRECTORY + fileName);
  ...
  public static class TestConfig {
    ...
    @Bean
    @Primary
    public SourceRecordStorageClient getMockSourceRecorStorageClient() {
