...
/**
 * Enum for initial data for transformation fields. Conventions: 1) Default fields must have
 * ".default" appended to the field name. 2) JSON filter for comparing Strings (including UUID) must
...
public enum TransformationFieldsConfig {
  ...
  METADATA_CREATED_BY_USER_ID(
      "metadata.createdByUserId", "$.{recordType}.metadata.createdByUserId"),
  METADATA_UPDATED_BY_USER_ID(
      "metadata.updatedByUserId", "$.{recordType}.metadata.updatedByUserId"),
  ...
  ELECTRONIC_ACCESS_PUBLICNOTE_DEFAULT(
      "electronic.access.publicNote.default",
      "$.{recordType}.electronicAccess[?(!(@.relationshipId) ||"
          + " @.relationshipId == null)].publicNote"),

  // Instance specific fields
  ALTERNATIVE_TITLES(
      "alternativeTitleTypeName",
  ...
  CONTRIBUTOR_NAME(
      ...
      "$.instance.contributors[?(@.contributorNameTypeId=='{id}' &&"
          + " (!(@.primary) || @.primary == false))].name",
      CONTRIBUTOR_NAME_TYPES),
  CONTRIBUTOR_NAME_PRIMARY(
      "contributorName.primary",
      "$.instance.contributors[?(@.contributorNameTypeId=='{id}' &&"
          + " ((@.primary) && @.primary == true))].name",
      CONTRIBUTOR_NAME_TYPES),
  EDITIONS("editions", "$.instance.editions"),
  IDENTIFIERS(
      "identifiers",
      "$.instance.identifiers[?(@.identifierTypeId=='{id}')].value",
      IDENTIFIER_TYPES),
  LANGUAGES("languages", "$.instance.languages"),
  MODE_OF_ISSUANCE_ID(
      "modeOfIssuanceId",
      "$.instance[?(@.modeOfIssuanceId=='{id}')].modeOfIssuanceId",
      ISSUANCE_MODES),
  INSTANCE_TYPE(
      "instanceTypeId", "$.instance[?(@.instanceTypeId=='{id}')].instanceTypeId", INSTANCE_TYPES),
  ...
  HOLDING_PERMANENT_LOCATION_LIBRARY_NAME(
      "permanentLocation.library.name", Constants.PERMANENT_LOCATION_ID),
  HOLDING_PERMANENT_LOCATION_LIBRARY_CODE(
      "permanentLocation.library.code", Constants.PERMANENT_LOCATION_ID),
  HOLDING_PERMANENT_LOCATION_CAMPUS_NAME(
      "permanentLocation.campus.name", Constants.PERMANENT_LOCATION_ID),
  HOLDING_PERMANENT_LOCATION_CAMPUS_CODE(
      "permanentLocation.campus.code", Constants.PERMANENT_LOCATION_ID),
  HOLDING_PERMANENT_LOCATION_INSTITUTION_NAME(
      "permanentLocation.institution.name", Constants.PERMANENT_LOCATION_ID),
  HOLDING_PERMANENT_LOCATION_INSTITUTION_CODE(
      "permanentLocation.institution.code", Constants.PERMANENT_LOCATION_ID),
  ...
  HOLDING_TEMPORARY_LOCATION_LIBRARY_NAME(
      "temporaryLocation.library.name", Constants.TEMPORARY_LOCATION_ID),
  HOLDING_TEMPORARY_LOCATION_LIBRARY_CODE(
      "temporaryLocation.library.code", Constants.TEMPORARY_LOCATION_ID),
  HOLDING_TEMPORARY_LOCATION_CAMPUS_NAME(
      "temporaryLocation.campus.name", Constants.TEMPORARY_LOCATION_ID),
  HOLDING_TEMPORARY_LOCATION_CAMPUS_CODE(
      "temporaryLocation.campus.code", Constants.TEMPORARY_LOCATION_ID),
  HOLDING_TEMPORARY_LOCATION_INSTITUTION_NAME(
      "temporaryLocation.institution.name", Constants.TEMPORARY_LOCATION_ID),
  HOLDING_TEMPORARY_LOCATION_INSTITUTION_CODE(
      "temporaryLocation.institution.code", Constants.TEMPORARY_LOCATION_ID),
  HOLDINGS_STATEMENT(
      "holdingsStatements.statement", "$.holdings[*].holdingsStatements[*].statement"),
  HOLDINGS_STATEMENT_NOTE("holdingsStatements.note", "$.holdings[*].holdingsStatements[*].note"),
  HOLDINGS_STATEMENT_NOTE_STAFF(
      "holdingsStatements.staffNote", "$.holdings[*].holdingsStatements[*].staffNote"),
  ...
  DESCRIPTION_OF_PIECES("descriptionOfPieces", "$.holdings[*].items[*].descriptionOfPieces"),
  ...
  PERMANENT_LOAN_TYPE_ID("permanentLoanTypeId", "$.holdings[*].items[*].permanentLoanTypeId"),
  ...
  ITEM_CALL_NUMBER("callNumber", "$.holdings[*].items[*].effectiveCallNumberComponents.callNumber"),
  ITEM_CALL_NUMBER_PREFIX(
      "callNumberPrefix", "$.holdings[*].items[*].effectiveCallNumberComponents.prefix"),
  ITEM_CALL_NUMBER_SUFFIX(
      "callNumberSuffix", "$.holdings[*].items[*].effectiveCallNumberComponents.suffix"),
  ITEM_CALL_NUMBER_TYPE(
      "callNumberType", "$.holdings[*].items[*].effectiveCallNumberComponents.typeId"),
  ITEM_NOTE_TYPE(
      "itemNoteTypeId",
  ...
  ITEM_PERMANENT_LOCATION_LIBRARY_NAME(
      "permanentLocation.library.name", HOLDINGS_ITEMS_PERMANENT_LOCATION_ID_PATH),
  ITEM_PERMANENT_LOCATION_LIBRARY_CODE(
      "permanentLocation.library.code", HOLDINGS_ITEMS_PERMANENT_LOCATION_ID_PATH),
  ITEM_PERMANENT_LOCATION_CAMPUS_NAME(
      "permanentLocation.campus.name", HOLDINGS_ITEMS_PERMANENT_LOCATION_ID_PATH),
  ITEM_PERMANENT_LOCATION_CAMPUS_CODE(
      "permanentLocation.campus.code", HOLDINGS_ITEMS_PERMANENT_LOCATION_ID_PATH),
  ITEM_PERMANENT_LOCATION_INSTITUTION_NAME(
      "permanentLocation.institution.name", HOLDINGS_ITEMS_PERMANENT_LOCATION_ID_PATH),
  ITEM_PERMANENT_LOCATION_INSTITUTION_CODE(
      "permanentLocation.institution.code", HOLDINGS_ITEMS_PERMANENT_LOCATION_ID_PATH),
  ...
  ITEM_EFFECTIVE_LOCATION_LIBRARY_NAME(
      "effectiveLocation.library.name", HOLDINGS_ITEMS_EFFECTIVE_LOCATION_ID_PATH),
  ITEM_EFFECTIVE_LOCATION_LIBRARY_CODE(
      "effectiveLocation.library.code", HOLDINGS_ITEMS_EFFECTIVE_LOCATION_ID_PATH),
  ITEM_EFFECTIVE_LOCATION_CAMPUS_NAME(
      "effectiveLocation.campus.name", HOLDINGS_ITEMS_EFFECTIVE_LOCATION_ID_PATH),
  ITEM_EFFECTIVE_LOCATION_CAMPUS_CODE(
      "effectiveLocation.campus.code", HOLDINGS_ITEMS_EFFECTIVE_LOCATION_ID_PATH),
  ITEM_EFFECTIVE_LOCATION_INSTITUTION_NAME(
      "effectiveLocation.institution.name", HOLDINGS_ITEMS_EFFECTIVE_LOCATION_ID_PATH),
  ITEM_EFFECTIVE_LOCATION_INSTITUTION_CODE(
      "effectiveLocation.institution.code", HOLDINGS_ITEMS_EFFECTIVE_LOCATION_ID_PATH);
