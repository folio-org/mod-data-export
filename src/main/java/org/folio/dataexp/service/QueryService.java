...
public class QueryService {
  ...
  /**
   * Retrieves entities from FQM based on identifiers. Callers should expect
   * to receive the generic return list and then process further by entity type.
   *
   ...
   */
  public List<Map<String, Object>> getEntities(Set<UUID> ids,
      UUID entityTypeId, List<String> fields) {
