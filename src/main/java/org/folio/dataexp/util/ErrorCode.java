...
public enum ErrorCode {
  ...
  ERROR_MESSAGE_HOLDINGS_NO_AFFILIATION("error.holdings.noAffiliation", "%s -  the user %s does not have permissions to access the holdings record in %s data tenant."),
  ERROR_MESSAGE_INSTANCE_NO_AFFILIATION("error.instance.noAffiliation", "%s the user %s is not affiliated with %s data tenant(s) and holdings and item records from this tenant were omitted during export."),
  ...
  ERROR_INSTANCE_NO_PERMISSION("error.instance.noPermission", "%s the user %s does not have permissions to view holdings or items in %s data tenant(s). Holdings and item records from this tenant were omitted during export.");
