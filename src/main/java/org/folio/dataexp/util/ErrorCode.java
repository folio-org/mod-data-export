...
public enum ErrorCode {
  ...
  S3_BUCKET_NAME_NOT_FOUND(
      "error.s3.bucketNameNotFound", "S3 bucket name is not found in System Properties"),
  NO_FILE_GENERATED("error.binaryFile.notGenerated", "Nothing to export: no output file generated"),
  USER_NOT_FOUND("error.user.notFound", "User not found"),
  INVALID_UPLOADED_FILE_EXTENSION(
      INVALID_EXTENSION_ERROR_CODE, "File name extension does not corresponds csv format"),
  INVALID_UPLOADED_FILE_EXTENSION_FOR_HOLDING_ID_TYPE(
      INVALID_EXTENSION_ERROR_CODE, "Only csv format is supported for holdings export"),
  INVALID_UPLOADED_FILE_EXTENSION_FOR_AUTHORITY_ID_TYPE(
      INVALID_EXTENSION_ERROR_CODE, "Only csv format is supported for authority export"),
  FILE_ALREADY_UPLOADED(
      "error.fileDefinition.fileAlreadyUploaded", "File already uploaded for this FileDefinition"),
  NOTHING_TO_EXPORT("error.nothingToExport", "No exported records, nothing to export"),
  FAIL_TO_UPDATE_JOB(
      "error.jobExecution.failToUpdateJob", "Fail to prepare job execution for export"),
  ERROR_QUERY_RULES_FROM_CONFIGURATIONS(
      "error.configurations.queryRules", "Error while query the rules from mod configuration: %s"),
  ...
  ERROR_GETTING_INSTANCES_BY_IDS(
      "error.inventory.gettingInstancesByIds", "Error while getting instances by ids. %s"),
  ERROR_GETTING_HOLDINGS_BY_IDS(
      ERROR_MESSAGE_PLACEHOLDER_CODE, "Error while getting holdings by ids. %s"),
  ...
  ERROR_GETTING_ITEM_BY_HOLDINGS_ID(
      "error.inventory.gettingItemsByHoldingsId", "Error while getting items by holding ids %s"),
  ERROR_CALLING_URI("error.callingUri", "Exception while calling %s, message: %s"),
  ERROR_GETTING_USER(
      "error.user.gettingById", "Error while getting user with id = %s, message: %s"),
  ERROR_SAVING_RECORD_TO_FILE("error.savingRecordToFile", "Error during saving record to file"),
  INVALID_EXPORT_FILE_DEFINITION_ID(
      "error.fileDefinition.invalidWithId", "Invalid export file definition with id: %s"),
  ...
  ERROR_MARC_RECORD_CANNOT_BE_CONVERTED(
      ERROR_MESSAGE_PLACEHOLDER_CODE, "Json record cannot be converted to marc format, cause: %s"),
  ...
  ERROR_ONLY_DEFAULT_HOLDING_JOB_PROFILE_IS_SUPPORTED(
      ERROR_MESSAGE_PLACEHOLDER_CODE,
  ...
  ERROR_JOB_IS_EXPIRED(
      ERROR_MESSAGE_PLACEHOLDER_CODE, "Job was expired: no updates for more than 1 hour"),
  ERROR_FILE_BEING_UPLOADED_IS_TOO_LARGE(
      "error.fileIsTooLarge", "File being uploaded is too large"),
  ...
  ERROR_MESSAGE_TENANT_NOT_FOUND_FOR_HOLDING(
      "error.tenantNotFoundForHolding", "Tenant cannot be found for holding with id %s"),
  ERROR_MESSAGE_HOLDINGS_NO_AFFILIATION(
      "error.holdings.noAffiliation",
      "%s -  the user %s does not have permissions to access the holdings record"
          + " in %s data tenant."),
  ERROR_MESSAGE_INSTANCE_NO_AFFILIATION(
      "error.instance.noAffiliation",
  ...
  ERROR_CONVERTING_JSON_TO_MARC(
      "error.convertJsonToMarc", "Error converting json to marc for record %s"),
  ERROR_RULE_NO_INDICATORS("error.noIndicators", "Tag rule %s doesn't have indicators"),
  ERROR_CONVERTING_TO_JSON_HOLDING(
      "error.convertingToJson.holding", "Error converting to json holding by id %s"),
  ERROR_CONVERTING_TO_JSON_INSTANCE(
      "error.convertingToJson.instance", "Error converting to json instance by id %s"),
  ERROR_DELETED_DUPLICATED_INSTANCE(
      "error.deletedDuplicate.instance", "Instance record associated with %s has been deleted."),
  ERROR_DELETED_TOO_LONG_INSTANCE(
      "error.deletedTooLong.instance", "Instance record with id = %s has been deleted."),
  ERROR_NON_EXISTING_INSTANCE("error.nonExisting.instance", "%s"),
  ERROR_HOLDINGS_NO_PERMISSION(
      "error.holdings.noPermission",
      "%s - the user %s does not have permissions to access the holdings record in %s data tenant."),
  ERROR_INSTANCE_NO_PERMISSION(
      "error.instance.noPermission",
  ...
  ERROR_CONVERTING_LD_TO_BIBFRAME(
      "error.convertLdToBf", "Error converting Linked Data resource to BIBFRAME 2.0 for record %s");
