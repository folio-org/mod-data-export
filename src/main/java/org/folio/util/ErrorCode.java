...
public enum ErrorCode {
  ...
  ERROR_ONLY_DEFAULT_HOLDING_JOB_PROFILE_IS_SUPPORTED("error.jobProfile.onlyDefaultHoldingJobProfileIsSupported", "For exporting holding records only the default holding job profile is supported");
