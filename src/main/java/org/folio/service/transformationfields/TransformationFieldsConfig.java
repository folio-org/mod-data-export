...
public enum TransformationFieldsConfig {
  ...
  ITEM_CALL_NUMBER_PREFIX("callNumberPrefix", "$.holdings[*].items[*].effectiveCallNumberComponents.prefix"),
  ITEM_CALL_NUMBER_SUFFIX("callNumberSuffix", "$.holdings[*].items[*].effectiveCallNumberComponents.suffix"),
